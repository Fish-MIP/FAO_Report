...
```{r}
human_pop <- drive_read_string("https://drive.google.com/file/d/1adH-7AbNJln9E9_vaGcyit-czMmkGndo/view?usp=drive_link") |> 
...
world_proj <- world_proj |> 
  left_join(human_pop |> select(!C_Name), by = join_by("adm0_a3" == "CCode"))
```

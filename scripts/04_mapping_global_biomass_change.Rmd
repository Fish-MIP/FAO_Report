...
base_gg <- list(scale_fill_binned(limits = c(-50, 50), n.breaks = 8,
                ...
                new_scale_fill(),
                geom_sf(inherit.aes = F, data = world_proj, aes(fill = MarCap1014),
                        show.legend = F),
                scale_fill_continuous(trans = "log10", type = scale_fill_viridis_c, 
                        option = "D"),
...
land <- ggplot()+
  geom_sf(data = world_proj, aes(fill = MarCap1014))+
  scale_fill_continuous(trans = "log10", type = scale_fill_viridis_c, 
                        option = "D", 
                        guides(title = "Mean yearly landings between 2005-2014\n(Log10 tonnes)"))+
...
base_gg <- list(scale_fill_binned(limits = c(-50, 50), n.breaks = 8,
                ...
                geom_sf(inherit.aes = F, data = fao_proj, fill = NA, colour = "#5b5b5b",
                        show.legend = F, linewidth = 0.25),
                geom_sf(inherit.aes = F, data = eez_proj, fill = "white", alpha = 0.2,

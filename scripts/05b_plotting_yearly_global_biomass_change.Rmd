...
uncert<-ggplot(filter(bio_dataOCD, fao_official != "Arctic Sea"), aes(x=fao_official, y=mean_change, group=scenario, color=scenario)) + 
  geom_point()+ 
...
png("figures/FAOarea_global_trends_ODC.png", width=7, height=5, units="in",res=1200)
uncert
dev.off()

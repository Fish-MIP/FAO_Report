...
eez_aggregated_df <- 
  ...
  #cmip 5 raster
  the_cmip_5_r <- rast(here("data/data_products/CMIP_5_gridded_SD.tif"))
...
saveRDS(object = cmip5_aggregated_df, file = here("data/data_products/cmip5_SD_aggregated_by_region.rds"))
...
eez_aggregated_df <- 
  ...
  #cmip 6 raster
  the_cmip_6_r <- rast(here("data/data_products/CMIP_6_gridded_SD.tif"))
...
saveRDS(object = cmip6_aggregated_df, file = here("data/data_products/cmip6_SD_aggregated_by_region.rds"))

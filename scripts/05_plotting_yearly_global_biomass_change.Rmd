...
#Filtering data for top 7 and calculating mean and sd for catches
top7 <- bio_data |> 
...
#Calculate mean and sd for catches globally
bio_data |> 
  ...
  mutate(SOVEREIGN1 = factor(SOVEREIGN1, levels = c("Global", unique(top7$SOVEREIGN1)), 
                             ordered = T)) |> 
  #Plotting

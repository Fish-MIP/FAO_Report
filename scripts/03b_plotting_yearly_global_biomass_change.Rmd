...
stats<-all_scale_data_by_model %>% 
  ...
  summarise(
    ...
    n_positive = sum(mean_across_decade >= 0), # non-negative, 0 included as per Tittensor. No difference as no true 0 in data.  
...
# # filed with names for all spatial_scale = figure_name
# filter(all_scale_data_by_model, spatial_scale == "countries")
# filter(all_scale_data_by_model, spatial_scale == "FAO_area")
# filter(all_scale_data_by_model, spatial_scale == "top_7_countries")
# filter(all_scale_data_by_model, spatial_scale == "global")
...
### problem with rounding numbers when calcaulting this adn then printing the table with round numbers 
filter(stats, figure_name == "Egypt")$mean[c(1,3)]
filter(losses, figure_name == "Egypt")
(1-(16.46322/0.003545606))*100
(1-(16.5/0))*100

filter(stats, figure_name == "Kerguelen Islands")$mean[c(1,3)]
filter(losses, figure_name == "Kerguelen Islands")
(1-(-4.639872/-5.981972))*100 # when calculating with raw numbers 
(1-(-4.6/-6))*100 # when calculating after numbers have been rounded on the printed table

filter(stats, figure_name == "Libya")$mean[c(1,3)]
filter(losses, figure_name == "Libya")
(1-(5.3161381/-0.3104229))*100
(1-(5.3/-0.3))*100
...
range(historical_sd$historical_sd)
...
# # Check historical sd - ARRIVATA QUI 
...
# new<-read_csv("data/data_products/table_stats.csv")
# 
# old<-old %>% 
...
table_formatted<-table %>% 
  ...
  mutate(mean = round(mean, 1), 
         ...
         # historical_sd = round(historical_sd, 2) # very small values 
         ) %>% 
  pivot_wider(names_from = id, values_from = c(mean, sd, agreement, wilcox_p, losses, losses_direction, historical_sd)) %>%
  relocate(spatial_scale, continent, figure_name,
           `mean_ssp126_2041-2050`,`sd_ssp126_2041-2050`,`agreement_ssp126_2041-2050`,`wilcox_p_ssp126_2041-2050`,`losses_ssp126_2041-2050`,`losses_direction_ssp126_2041-2050`,`historical_sd_ssp126_2041-2050`,
           `mean_ssp585_2041-2050`,`sd_ssp585_2041-2050`,`agreement_ssp585_2041-2050`,`wilcox_p_ssp585_2041-2050`,`losses_ssp585_2041-2050`,`losses_direction_ssp585_2041-2050`,`historical_sd_ssp126_2041-2050`,
           `mean_ssp126_2091-2100`,`sd_ssp126_2091-2100`,`agreement_ssp126_2091-2100`,`wilcox_p_ssp126_2091-2100`,`losses_ssp126_2091-2100`,`losses_direction_ssp126_2091-2100`,`historical_sd_ssp126_2091-2100`,
           `mean_ssp585_2091-2100`,`sd_ssp585_2091-2100`,`agreement_ssp585_2091-2100`,`wilcox_p_ssp585_2091-2100`,`losses_ssp585_2091-2100`,`losses_direction_ssp585_2091-2100`,`historical_sd_ssp126_2091-2100`)  %>% 
  select(!c(`wilcox_p_ssp126_2041-2050`,`wilcox_p_ssp126_2091-2100`,
            `losses_ssp126_2041-2050`,`losses_ssp126_2091-2100`,
            `losses_direction_ssp126_2041-2050`,`losses_direction_ssp126_2091-2100`, 
            `historical_sd_ssp126_2041-2050`,`historical_sd_ssp126_2091-2100`,`historical_sd_ssp585_2041-2050`)) %>% # wilcox and losses are the same across scenarios but different across decades so i keep only ssp585 for both decades. historical_sd is unique across scenarios and decade, so keep only one
  rename(`wolcox_2041-2050` = `wilcox_p_ssp585_2041-2050`, `wolcox_2091-2100` =`wilcox_p_ssp585_2091-2100`,
         `losses_2041-2050` = `losses_ssp585_2041-2050`, `losses_2091-2100` =`losses_ssp585_2091-2100`,
         `losses_direction_2041-2050` = `losses_direction_ssp585_2041-2050`, `losses_direction_2091-2100` = `losses_direction_ssp585_2091-2100`,`historical_sd` = `historical_sd_ssp585_2091-2100`) %>% 
...
# View(table_formatted)

fwrite(table_formatted, "data/data_products/table_stats_formatted.csv")
...
pdf("data/data_products/top_7_perc_change.pdf", width=9, height= 10)
top_7
dev.off()
...
pdf("data/data_products/asia_perc_change.pdf", width=9, height= 10)
asia
dev.off()
...
pdf("data/data_products/africa_perc_change.pdf", width=9, height= 12)
africa
dev.off()
```
...
pdf("data/data_products/europe_perc_change.pdf", width=9, height= 9)
europe
dev.off()
...
pdf("data/data_products/americas_perc_change.pdf", width=9, height= 13)
americas
dev.off()
```
...
pdf("data/data_products/oceania_perc_change.pdf", width=9, height= 9)
oceania
dev.off()
```
...
pdf("data/data_products/fao_regions_perc_change.pdf", width=9, height= 6)
fao_regions
dev.off()
```

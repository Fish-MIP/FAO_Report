...
fwrite(table, paste0("outputs/","table_stats.csv")) 
...
fwrite(table_formatted, paste0("outputs/","table_stats_formatted.csv")) 
...
pdf(file.path("outputs/", "top_7_global_trends.pdf"), width=9, height= 10)
top_7
dev.off()
```
...
pdf(file.path("outputs/", "asia_perc_change.pdf"), width=9, height= 10)
asia
dev.off()
```
...
pdf(file.path("outputs/", "africa_perc_change.pdf"), width=9, height= 12)
africa
dev.off()
```
...
pdf(file.path("outputs/", "europe_perc_change.pdf"), width=9, height= 9)
europe
dev.off()
```
...
pdf(file.path("outputs/", "americas_perc_change.pdf"), width=9, height= 13)
americas
dev.off()
```
...
pdf(file.path("outputs/", "oceania_perc_change.pdf"), width=9, height= 9)
oceania
dev.off()
```
...
pdf(file.path("outputs/", "fao_regions_perc_change.pdf"), width=9, height= 6)
fao_regions
dev.off()
```
...
png("outputs/FAOarea_uncertity.png", width=10, height=5, units="in",res=1200)
uncert_decade
dev.off()

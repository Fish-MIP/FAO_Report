...
fwrite(table, "data/table_stats.csv") 
...
new<-read_csv("data/table_stats.csv")
...
table_formatted<-table %>% 
  ...
  pivot_wider(names_from = id, values_from = c(mean, sd, min, max, n_model, agreement, wilcox_p)) %>%
  relocate(spatial_scale, continent, figure_name,
           `mean_ssp126_2041-2050`,`sd_ssp126_2041-2050`,`min_ssp126_2041-2050`,`max_ssp126_2041-2050`,`n_model_ssp126_2041-2050`,`agreement_ssp126_2041-2050`,`wilcox_p_ssp126_2041-2050`,
           `mean_ssp585_2041-2050`,`sd_ssp585_2041-2050`,`min_ssp585_2041-2050`,`max_ssp585_2041-2050`,`n_model_ssp585_2041-2050`,`agreement_ssp585_2041-2050`,`wilcox_p_ssp585_2041-2050`,
           `mean_ssp126_2091-2100`,`sd_ssp126_2091-2100`,`min_ssp126_2091-2100`,`max_ssp126_2091-2100`,`n_model_ssp126_2091-2100`,`agreement_ssp126_2091-2100`,`wilcox_p_ssp126_2091-2100`,
           `mean_ssp585_2091-2100`,`sd_ssp585_2091-2100`,`min_ssp585_2091-2100`,`max_ssp585_2091-2100`,`n_model_ssp585_2091-2100`,`agreement_ssp585_2091-2100`,`wilcox_p_ssp585_2091-2100`)  %>% 
  select(!c(`n_model_ssp126_2041-2050`,`n_model_ssp585_2041-2050`,`n_model_ssp126_2091-2100`,`n_model_ssp585_2091-2100`, `wilcox_p_ssp126_2041-2050`,`wilcox_p_ssp126_2091-2100`)) %>% # n_model is the same across scenario and decade (but remove), wilcox is the same across scenarios but different across decades. 
...
fwrite(table_formatted, "data/table_stats_formatted.csv")

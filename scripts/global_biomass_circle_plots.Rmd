...
# 
# ggsave(plot = g_legend, glue(here("scripts/circle_figs/legend_vertical.png")), height=20, width=20, units=c("in"), bg = "white") # for vertical
...
ggsave(plot = g, here("scripts/circle_figs/test.png"), bg = "white", height=20, width=20, units=c("in"))
```
...
ggsave(plot = p1, glue(here("scripts/circle_figs/maps/map_{scen}_{decade_type}.png")), bg = "white")

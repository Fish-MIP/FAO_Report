...
# Warning message:                                                                                                     
# In left_join(drop_na(left_join(as.data.frame(ras_area, xy = T),  :
#   Detected an unexpected many-to-many relationship between `x` and `y`.
# ℹ Row 8721 of `x` matches multiple rows in `y`.
...
ipsl_lme_df <- rast_df(ipsl_lme, ipsl, meta_lme, 
                       file.path(fao_dir, "ipsl-cm6a_60arcmin_global_FAO-LME.csv"))

...
# (maps_data_sd/abs(maps_data))*100

colnames(maps_data_sd)
colnames(maps_data)
maps_data_cv<-maps_data_sd %>% 
  full_join(maps_data) %>% 
  mutate(rel_change_mean50_ssp126_cv = (rel_change_mean50_ssp126_sd/abs(rel_change_mean50_ssp126_mean))*100, 
         rel_change_mean00_ssp126_cv = (rel_change_mean00_ssp126_sd/abs(rel_change_mean00_ssp126_mean))*100,
         rel_change_mean50_ssp585_cv = (rel_change_mean50_ssp585_sd/abs(rel_change_mean50_ssp585_mean))*100,
         rel_change_mean00_ssp585_cv = (rel_change_mean00_ssp585_sd/abs(rel_change_mean00_ssp585_mean))*100)

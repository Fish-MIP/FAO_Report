...
for(m in members){
  ...
  area_grid <- area_grid |> 
    # drop_na(fao_official) |> # calculating trends for the whole globe 
    #Remove columns that are not relevant
    select(x:cell_area)
  
  # check mask - whole globe
  # library(raster)

...
```{r}
#Getting GFDL grid area
area_gfdl_lme <- read_csv(file.path(out_folder, "Merged_FAO_EEZ/gfdl-esm4_60arcmin_global_FAO-LME.csv"))

#Getting IPSL grid area
area_ipsl_lme <- read_csv(file.path(out_folder, "Merged_FAO_EEZ/ipsl-cm6a_60arcmin_global_FAO-LME.csv"))
```

...
#FAO_EEZ key - Contains continent information - UPDATED FILE! - Denisse
fao_eez <- read_csv(file.path(out_folder, "Merged_FAO_EEZ/FAO_MajorAreas_200NM_cont_keys.csv"))

colnames(fao_eez)

# ## WARNING cannot locate the file anymore. it works if I do this 
# fao_eez <- read_csv(list.files("/rd/gem/private", 
#                                pattern = "FAO-MajorAreas_EEZs_keys.csv", 
#                                full.names = T, recursive = T))
# getwd()
# fwrite(fao_eez, "FAO-MajorAreas_EEZs_keys.csv")

fao_eez<-read_csv("FAO-MajorAreas_EEZs_keys.csv")

...
Code for saving non-stacked plots: 
...
geom_text(
  ...
  # saveRDS(g, glue(here("outputs/circle_figs/{spatial_type}/non_stacked/bar_{scen}_{decade_type}.rds"))) # save as rds, so that we can read back in the ggplot into the shiny app

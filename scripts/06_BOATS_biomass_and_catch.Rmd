...
global_sum<-fread("data/BOATS_data.csv") %>% 
...
base_gg1 <- list(geom_line(linewidth = 1),
...
base_gg2 <- list(geom_line(linewidth = 1),
                #Adding line dividing historical period and future projections
                geom_vline(xintercept = 2015, color = "grey80",
                           linewidth = 0.65),
                #Manually setting colours to be used in plots
...
pdf("data/data_products/BOATS_trends.pdf", width=9, height= 5)
fig_boats
dev.off()

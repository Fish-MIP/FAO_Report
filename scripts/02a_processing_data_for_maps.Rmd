...
## Commented out as not used in FAO report adn currently re-running analysis to provide high res final plots. 
# #Adding LME metadata
...
maps_data |> 
  ...
  # left_join(lme, join_by(x, y)) |> # Commented out as per reason above. 
